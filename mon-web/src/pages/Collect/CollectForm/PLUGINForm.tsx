...
import AceEditor from '@pkgs/AceEditor';
...
const CollectForm = (props: any) => {
  ...
  return (
    <Form layout="horizontal" onSubmit={handleSubmit}>
      ...
      <FormItem {...formItemLayout} label={intlFmtMsg({ id: 'collect.plugin.filepath' })}>
        <Input
      ...
      <FormItem {...formItemLayout} label={intlFmtMsg({ id: 'collect.plugin.params' })}>
        <Input
          placeholder=""
      ...
      <FormItem {...formItemLayout} label={intlFmtMsg({ id: 'collect.plugin.env' })}>
        {
