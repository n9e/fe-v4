...
export default {
  ...
  'tpl.title': '标题',
  'tpl.title.tpl.help': '标题，说明这个模板的作用',
  ...
  'tpl.pause.help': '暂停点，做完某台之后暂停一下，要暂停多台，写多个 host {habitsId}，逗号分隔',
  ...
  'groups.instGroups': '即时任务',
  'groups.crontabGroups': '定时任务',

  'perms.hosts': '机器',
  'perms.host': '机器',
  'perms.team': '有权限的团队',
  'perms.account': '脚本执行账号',
